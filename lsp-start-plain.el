...
(let* ((package-archives '(("melpa" . "https://melpa.org/packages/")
       ...
       (pkg-list '(lsp-mode lsp-ui yasnippet lsp-java lsp-python-ms lsp-haskell helm-lsp lsp-treemacs dap-mode lsp-origami lsp-dart company flycheck auto-rename-tag typescript-mode)))
